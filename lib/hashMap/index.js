 ...
 * 
 * robin hood hashing - seeking place for hash in one slot buckets, 
 * comparing how far those values are, and swapping them:
 * Compare probe distance
 * If new element has probed farther swap
 * Continue with the displaced element
 * */
